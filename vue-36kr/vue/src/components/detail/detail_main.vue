        ...
        <div class="content-wrapper">
            ...
            <div class="mobile_article">
                ...
                <div class="am-cf author-panel">
                    ...
                    <a href="/user/375349" class="am-fl">
                ...
                <section class="single-post-tags">
                    <a class="kr-tag-gray" :href="catalog.href" target="_blank" v-for="catalog in article.catalogs">{{catalog.name}}</a>
                </section>
