...
<template lang="html">
    <div class="table-pad">
        <div class="btn-gro">
            ...
            <el-button @click="btnConfig" type="success" icon="el-icon-setting" :size="size">配置</el-button>
        ...
        <MailConfig ref="configModel" :size="size"/>
...
import SearchSafe from '@/components/auto/safe/SearchSafe'
import MailConfig from '@/components/auto/safe/MailConfig'
...
export default {
    ...
    methods: {
        async refresh () { // 刷新列表
            this.loading = true
            getReportList(this.data.startTime, this.data.endTime, this.currentPage, this.perPage).then(json=>{
                this.list = json.data
    ...
    components: {
        SearchSafe, MailConfig, HelpModel
    }
}
